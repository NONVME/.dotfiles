return {
  ...
  require("gitsigns").setup({
    ...
    on_attach = function(bufnr)
      ...
      vim.keymap.set('n', '<leader>ib', function() gs.blame_line{full=true} end, {desc = "Git Blame line"})
      ...
      vim.keymap.set('n', '<leader>iD', function() gs.diffthis('@~2') end, {desc = "Git Diff Version of file in the grandparent of HEAD"})
